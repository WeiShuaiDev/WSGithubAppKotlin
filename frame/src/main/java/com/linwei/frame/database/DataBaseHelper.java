...
//                return logs;
//            }
//            Map<Long, List<NumberEntity>> contactIdNumbersMap = Nested.queryAllContactNumbers();
//            Map<Long, ContactDetail> contactDetailMap = Nested.queryAllContactDetail();
//
...
//         * 查询所有电话号码
//         */
//        private static Map<Long, List<NumberEntity>> queryAllContactNumbers() {
//
//            Map<Long, List<NumberEntity>> idNumbersMap = new HashMap<>();
//            Cursor cursor = null;
//            try {
...
//
//                    com.annimon.stream.Optional<NumberEntity> entityOpt = readOneNumber(cursor);
//
//                    if (!entityOpt.isPresent()) {
//                        continue;
//                    }
//
//                    List<NumberEntity> numbers = idNumbersMap.get(contactId);
//                    if (numbers == null) {
//                        List<NumberEntity> init = new ArrayList<>();
...
//         * 取出一条电话号码
//         */
//        private static com.annimon.stream.Optional<NumberEntity> readOneNumber(Cursor cursor) {
//            try {
